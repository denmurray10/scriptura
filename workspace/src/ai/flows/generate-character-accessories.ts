...
// Define the input schema locally to avoid import issues.
const GenerateCharacterAccessoriesFlowInputSchema = z.object({
...
const generateCharacterAccessoriesFlow = ai.defineFlow(
  {
    ...
    inputSchema: GenerateCharacterAccessoriesFlowInputSchema,
